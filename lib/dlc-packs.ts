...
export const DLC_PACKS: Record<string, DLCPack> = {
  DLC_VEHICLES: {
    ...
    image_url: '/images/dlc-vehicles.png',
    items: [
      {
        id: 'caravan',
        ...
        image_url: '/images/99-dodge-caravan.png',
        type: 'vehicle',
      },
      {
        id: 'swift',
        ...
        image_url: '/images/11-suzuki-swift.png',
        type: 'vehicle',
      },
    ],
  },
  DLC_ACCESSORIES: {
    ...
    image_url: '/images/license-plate.png',
    items: [
      {
        id: 'license-plate',
  ...
  DLC_AUDIO: {
    ...
    image_url: '/images/dlc-audio.png',
    items: [
      {
        id: 'fm-radio',
        name: 'FM Radio',
  ...
  DLC_BOOSTS: {
    ...
    image_url: '/images/dlc-boosts.png',
    items: [
      {
        id: 'red-bull-fridge',
        ...
        image_url: '/images/hawkey-fridge.png',
        type: 'boost',
      },
      {
        id: 'trucoat',
      ...
      },
      {
        ...
        image_url: '/images/costco-membership-card.png',
        type: 'boost',
      },
    ],
  },
